    ...
    <div class="col-12">
      <div class="card m-b-20">
        <div class="card-body">
          ...
          <p class="text-muted m-b-30">List of Category for website.
            <thead>
              <tr>
                <th>#</th>
                <th>Category Name</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                    <a class="btn btn-info" href="{{route('category.edit',['id' => $value->id])}}"><i class="ion-edit"></i></a>
                    <a class="btn btn-danger" href="{{route('category.delete',['id' => $value->id])}}"><i class="ion-android-close"></i></a>
                </td>
              </tr>
              @empty
              <tr>
